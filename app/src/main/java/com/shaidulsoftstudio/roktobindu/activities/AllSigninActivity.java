...
import com.shaidulsoftstudio.roktobindu.databinding.ActivityAllSigninBinding;
...
public class AllSigninActivity extends AppCompatActivity {
    ...
    ActivityAllSigninBinding binding;
    ...
    String fullname = "", gender = "", mobile = "", countryCodenumber = "",
            countryCodewithnumber = "", bloodGroup = "", District = "", Division = "",
            Upzila = "", Union = "", village = "", userType = "", email = "", password = "", confirmPassword = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityAllSigninBinding.inflate(getLayoutInflater());
    ...
    private void myproject() {
        ButterKnife.bind(AllSigninActivity.this);
        ...
        listener = firebaseListener -> {
            FirebaseUser firebaseUser = firebaseListener.getCurrentUser();
            ...
            if (firebaseUser != null) {
                databaseReference.child(FirebaseAuth.getInstance().getCurrentUser().getUid())
                        .addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()) {
                                    Users modelUsers = snapshot.getValue(Users.class);
                                    Home(modelUsers);
                                } else {

                                    USersDetailsLayout();
                                }
                                Toast.makeText(AllSigninActivity.this, "error 1", Toast.LENGTH_SHORT).show();
                ...
                AuthMethodPickerLayout pickerLayout = new AuthMethodPickerLayout
                        ...
                        .setPhoneButtonId(R.id.sign_in_phone_btn)
                        .setGoogleButtonId(R.id.sign_in_google_btn)
                        .setEmailButtonId(R.id.create_new_account_btn)
                        .build();
    ...
    private void Home(Users modelUsers) {

        currentUser = modelUsers;
        startActivity(new Intent(AllSigninActivity.this, MainActivity.class));
        finish();
    }

    private void USersDetailsLayout() {

        AlertDialog.Builder builder = new AlertDialog.Builder(AllSigninActivity.this,R.style.Theme_RoktoBindu);
        View view = LayoutInflater.from(this).inflate(R.layout.phoneauth_users_details_layout, null);

        TextView adressEdt = view.findViewById(R.id.phone_addresEdT);
        TextView registerBtn = view.findViewById(R.id.phone_registerbtnDonor);
        EditText name = view.findViewById(R.id.phone_nameEdt);
        EditText emailEdt = view.findViewById(R.id.phone_registeremailEdt);
        EditText passwordEdt = view.findViewById(R.id.phone_registerpassEdt);
        EditText confirm_pass = view.findViewById(R.id.phone_confirmpassEdt);
        EditText mobileEdt = view.findViewById(R.id.phone_phonenumberEdt);
        Spinner genderspin = view.findViewById(R.id.phone_genderSpinner);
        Spinner usertype = view.findViewById(R.id.phone_userTypeSpinner);
        Spinner blood_group = view.findViewById(R.id.phone_bloodgrpSpinner);
        Spinner division = view.findViewById(R.id.phone_divisionSpinner);
        Spinner district = view.findViewById(R.id.phone_districtSpinner);
        Spinner upzila = view.findViewById(R.id.phone_upzillaSpinner);
        Spinner union = view.findViewById(R.id.phone_unionSpinner);
        CountryCodePicker countryPicker = view.findViewById(R.id.phone_countryPicker);

        fullname = name.getText().toString().trim();
        mobile = mobileEdt.getText().toString().trim();
       // gender = genderspin.getSelectedItem().toString().trim();
       // bloodGroup = blood_group.getSelectedItem().toString().trim();
       // userType = usertype.getSelectedItem().toString().trim();
      //  Division = division.getSelectedItem().toString().trim();
     //   District = district.getSelectedItem().toString().trim();
      //  Upzila = upzila.getSelectedItem().toString().trim();
      //  Union = union.getSelectedItem().toString().trim();
        village = adressEdt.getText().toString().trim();
        countryCodewithnumber = countryPicker.getSelectedCountryCodeWithPlus() + " " + mobile;
        countryCodenumber = countryPicker.getSelectedCountryCodeWithPlus();
        ...
        if (TextUtils.isEmpty(fullname)) {
            ...
            Toast.makeText(AllSigninActivity.this, "Gender is required", Toast.LENGTH_SHORT).show();

        } else if (bloodGroup.equals("Select your Blood Group")) {
            Toast.makeText(AllSigninActivity.this, "Blood group is required", Toast.LENGTH_SHORT).show();

        } else if (userType.equals("Select User Type")) {
            Toast.makeText(AllSigninActivity.this, "User type is required", Toast.LENGTH_SHORT).show();

        } else if (Division.equals("Select Your Division")) {
            Toast.makeText(AllSigninActivity.this, "District is required", Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(AllSigninActivity.this, "Upzila is required", Toast.LENGTH_SHORT).show();
            showAlert("Field is required");

        } else if (Union.equals("Select Your Union")) {
            Toast.makeText(AllSigninActivity.this, "Union is required", Toast.LENGTH_SHORT).show();
            showAlert("Field is required");

        } else if (TextUtils.isEmpty(village)) {
            adressEdt.setError("Village required");
            ...
            passwordEdt.setError("Password atleast 6 Char");
        } else if (TextUtils.isEmpty(confirmPassword)) {
            confirm_pass.setError("Confirm pass required");

        } else if (!password.equals(confirmPassword)) {
            showAlert("Password don\'t match");
            Toast.makeText(AllSigninActivity.this, "Password don\'t match", Toast.LENGTH_SHORT).show();
        } else if (mobile.length() != 11) {
            showAlert("Invalid Phone number.Enter at least 11 char");
        } else {
            Toast.makeText(this, "no varification", Toast.LENGTH_SHORT).show();
        }

        genderAdapter = ArrayAdapter.createFromResource(AllSigninActivity.this,
                R.array.gender, R.layout.spinner_layout_gender);
        bloodGroupAdapter = ArrayAdapter.createFromResource(AllSigninActivity.this,
                R.array.blood_groups, R.layout.spinner_layout);
        userTypeAdapter = ArrayAdapter.createFromResource(AllSigninActivity.this,
                R.array.userType, R.layout.spinner_layout);
        divisionAdapter = ArrayAdapter.createFromResource(AllSigninActivity.this,
        ...
        blood_group.setAdapter(bloodGroupAdapter);
        ...
        division.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                divisionSpin = division.getSelectedItem().toString().trim();
                ...
                if (parentId == R.id.divisionSpinner) {
                    ...
                    district.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        ...
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            ...
                            districtSpin = district.getSelectedItem().toString().trim();
                            int parentId = parent.getId();
                            if (parentId == R.id.districtSpinner) {
                                ...
                                upzila.setAdapter(upzillaAdapter);
                                upzila.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                                    @Override
                                    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                                        upzelaSpin = upzila.getSelectedItem().toString().trim();
                                        int parentId = parent.getId();
                                        if (parentId == R.id.upzillaSpinner) {
                                            ...
                                            union.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                                                @Override
                                                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                                                    unionSpin = union.getSelectedItem().toString().trim();
                                                }
                    ...
                    Toast.makeText(AllSigninActivity.this,
...
//spinner end=============================================================================================
      ...
      registerBtn.setOnClickListener(new View.OnClickListener() {
          ...
          public void onClick(View v) {
              ...
              model.setGender(genderspin.getSelectedItem().toString().trim());
              model.setBloodGroup(blood_group.getSelectedItem().toString().trim());
              model.setUsertype(usertype.getSelectedItem().toString().trim());
              model.setDivision(division.getSelectedItem().toString().trim());
              model.setDistrict(district.getSelectedItem().toString().trim());
              model.setUpzila(upzila.getSelectedItem().toString().trim());
              model.setUnion(union.getSelectedItem().toString().trim());
              model.setVillage(village);
              model.setCountryCodenumber(countryCodenumber);
              model.setCountryCodewithnumber(countryCodewithnumber);
              ...
              databaseReference.child(FirebaseAuth.getInstance().getCurrentUser().getUid())
                      ...
                      .addOnSuccessListener(new OnSuccessListener<Void>() {
                          ...
                          public void onSuccess(Void unused) {
                              Toast.makeText(AllSigninActivity.this, "Register success", Toast.LENGTH_SHORT).show();
                          ...
                          public void onFailure(@NonNull Exception e) {
                              ...
                              dialog.dismiss();
                              Toast.makeText(AllSigninActivity.this, "Error"+e.getMessage(), Toast.LENGTH_SHORT).show();
                          }
                      });
          }
      });
    ...
    private void splashScreen() {
        Completable.timer(2500, TimeUnit.MILLISECONDS,
                AndroidSchedulers.mainThread()).subscribe(new Action() {
            @Override
    ...
    private void showAlert(String msg) {
        AlertDialog.Builder builder = new AlertDialog.Builder(AllSigninActivity.this);
